<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Tsukkomi.Login" %>
                    ...
                    <div class="right">
                        <div class="zhuce">
                          ...
                          <%--      <input type="text" placeholder="用户名邮箱" id="inputkey">--%>
                                    <asp:TextBox ID="userName" runat="server" placeholder="用户名/邮箱"></asp:TextBox>
                                </li>
                                <li>密码：
